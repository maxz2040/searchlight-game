// SvgCreature — 12 inline SVG characters.
// All shapes are original artwork, no external assets required.
// Each fits a 100×100 viewBox. The CSS filter in Creature.tsx handles
// the hidden/found visual states (brightness, drop-shadow) — render
// at full colour here and let the parent filter do the work.
